...
public class ChildSmartRegisterFragment extends BaseSmartRegisterFragment implements SyncStatusBroadcastReceiver.SyncStatusListener {
    ...
    protected SecuredNativeSmartRegisterActivity.DefaultOptionsProvider getDefaultOptionsProvider() {
        return new SecuredNativeSmartRegisterActivity.DefaultOptionsProvider() {
            ...
            public String nameInShortFormForTitle() {
                return context().getStringResource(R.string.ondo);
            }
        };
    }
    ...
    private String filterSelectionCondition(boolean urgentOnly) {
        ...
        String mainCondition = DOD_MAIN_CONDITION +
                AND + " (" + PathConstants.EC_CHILD_TABLE.INACTIVE + IS_NULL_OR + PathConstants.EC_CHILD_TABLE.INACTIVE + " != " + TRUE + " ) " +
                AND + " (" + PathConstants.EC_CHILD_TABLE.LOST_TO_FOLLOW_UP + IS_NULL_OR + PathConstants.EC_CHILD_TABLE.LOST_TO_FOLLOW_UP + " != " + TRUE + " ) " +
                AND + " ( ";
    ...
    private void switchViews(boolean filterSelected) {
        if (filterSelected) {
            ...
            if (titleLabelView != null) {
                titleLabelView.setText(getString(R.string.ondo));
            }
