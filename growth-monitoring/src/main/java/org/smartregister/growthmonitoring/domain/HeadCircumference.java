...
public class HeadCircumference {
    ...
    public HeadCircumference(Long id, String baseEntityId, Float inch, Date date, String anmId, String
    ...
    public HeadCircumference(Long id, String baseEntityId, String programClientId, Float inch, Date date,
