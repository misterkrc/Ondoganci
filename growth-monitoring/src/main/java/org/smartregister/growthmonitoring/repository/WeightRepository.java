...
public class WeightRepository extends BaseRepository {
    ...
    public static final String UPDATE_TABLE_ADD_TEAM_COL = "ALTER TABLE weights ADD COLUMN team VARCHAR;";
    public static final String UPDATE_TABLE_ADD_TEAM_ID_COL = "ALTER TABLE weights ADD COLUMN team_id VARCHAR;";
    public static final String UPDATE_TABLE_ADD_CHILD_LOCATION_ID_COL = "ALTER TABLE weights ADD COLUMN child_location_id VARCHAR;";
